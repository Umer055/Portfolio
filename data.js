...
/* ── DATA VERSION ──
   Bump this string whenever you push changes to data.js that you want
   the live site to pick up. Any visitor whose localStorage version
   doesn't match will have their cache cleared automatically.
   Format: 'YYYY-MM-DD.N' — e.g. '2026-05-06.2' for the 2nd deploy today. */
const DATA_VERSION = '2026-05-06.1';
...
/* ── VERSION-FLUSH ──
   On every page load compare the stored version against DATA_VERSION.
   If they differ (or if no version is stored), wipe all data keys so
   the fresh defaults in this file are used instead of stale localStorage. */
(function flushIfVersionChanged() {
  const VERSION_KEY = 'uf_data_version';
